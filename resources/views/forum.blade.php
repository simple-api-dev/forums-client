                ...
                <div>
                    ...
                    <div class="m-2 p-2">
                        @foreach($moderators_content as $item)
                            <div>
                                {{$item->author_id}}
                                [{{$item->status}}]
                                <a href="{{getenv('FORUM_CLIENT')}}/editModerator/{{$forum_content->id}}/{{$forum_content->slug}}/{{$item->id}}?apikey={{getenv('API_KEY')}}"><i
                        ...
                        <div class="text-right m-2">
                            <a href="{{getenv('FORUM_CLIENT')}}/createModerator/{{$forum_content->id}}/{{$forum_content->slug}}?apikey={{getenv('API_KEY')}}">
                                <button class="bg-blue-800 rounded-lg p-1 text-white hover:bg-blue-600">Create
                                    Moderator
                                </button>
                            </a>
                        </div>
                    ...
                    <div class="m-2 p-2">
                        @foreach($rules_content as $item)
                            <div class="border-2 border-solid border-slate-400 m-2 p-2">
                                ...
                                <a href="{{getenv('FORUM_CLIENT')}}/editRule/{{$forum_content->id}}/{{$forum_content->slug}}/{{$item->id}}?apikey={{getenv('API_KEY')}}"><i class="fa fa-pen text-gray-400 hover:text-black"></i></a>
                                <a href="{{getenv('FORUM_CLIENT')}}/deleteRule/{{$forum_content->id}}/{{$forum_content->slug}}/{{$item->id}}?apikey={{getenv('API_KEY')}}"><i class="fa fa-trash text-gray-400 hover:text-black"></i></a>
                            </div>
                        @endforeach

                        <div class="text-right m-2">
                            <a href="{{getenv('FORUM_CLIENT')}}/deleteAllRule/{{$forum_content->id}}/{{$forum_content->slug}}?apikey={{getenv('API_KEY')}}">
                                <button class="bg-blue-800 rounded-lg p-1 text-white hover:bg-blue-600">Remove All
                                    Rules
                                </button>
                            </a>
                            <a href="{{getenv('FORUM_CLIENT')}}/createRule/{{$forum_content->id}}/{{$forum_content->slug}}?apikey={{getenv('API_KEY')}}">
                                <button class="bg-blue-800 rounded-lg p-1 text-white hover:bg-blue-600">Create Rule
                                </button>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="m-2 p-2">
                        ...
                        <div class="text-right m-2">
                            ...
                            <button class="bg-blue-800 rounded-lg p-1 text-white hover:bg-blue-600">Create Tag</button>
                            </a>
                        </div>
                    </div>
